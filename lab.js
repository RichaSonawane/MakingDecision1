...
if(amysBirthYear > brittanisBirthYear){
  ...
  console.log("They both are of same age.")
}

////////// PROBLEM 3 //////////

/*
  Using an if statement and a comparison operator, create code that will check 
  if Amy and Brittani were born in the same year. If they were, console.log 'Amy & Brittani were
   born in the same year'. If they were not, console.log 'Amy & Brittani were not born in the same year'
*/

//CODE HERE
if (amysAge === brittanisAge){
  console.log("Amy & Brittani were born in same year.")
}
else{
  ...
  If it is 80 degrees or above, and raining, one should wear a t-shirt and take an umbrella.
   If it is between 60 and 80 degrees, and raining, one should wear a rain-jacket.
    If it is 60 degrees or below, one should wear a jacket and carry an umbrella.
     Come up with your own clothing suggestions based on those temperature parameters 
...
/*
  Create a for-loop that logs the numbers 0 through 10 backwards. Ex, 
  on the first iteration it would log 10, on the second iteration it would log 9.
*/
...
/*
  ...
  Check to see if changeMyMind is set to true or false, if it is true, change the status to 
  false, if it is false, change the status to true.
...
let z = 5;
// Create a while loop that continues to run while z is greater than 0. Within
 //the while loop, log a countdown from the value of z to 1. Once you have logged the countdown,
